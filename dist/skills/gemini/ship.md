...
- **qa** (프롬프트 파일: `skills/qa.md`)의 승인(APPROVED) 없이 릴리즈를 진행하지 마세요.
...
|----------|---------|---------------|
| 서버 배포 | **ops** (프롬프트 파일: `skills/ops.md`) | 릴리즈 태그 + 변경 내역 요약 |
| 개발 기록 | **docs** (프롬프트 파일: `skills/docs.md`) | CHANGELOG + 기술적 결정 사항 |
...
| 상황 | 대응 |
|------|------|
| **qa** (프롬프트 파일: `skills/qa.md`) 승인 없이 릴리즈 요청 | STOP. 테스트 승인 먼저. |
