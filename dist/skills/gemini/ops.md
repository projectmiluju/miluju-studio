...
<!-- 대상 에이전트: Gemini CLI | 스킬 버전: 1.0.0 | 생성일: 2026-04-29 -->
...
**입력:** **ship** (프롬프트 파일: `skills/ship.md`)의 릴리즈 태그 + 프로젝트 기술 스택
...
|----------|---------|---------------|
| 배포 기록 | **docs** (프롬프트 파일: `skills/docs.md`) | 배포 일시, 버전, 인프라 변경 |
| 문제 발생 | **build** (프롬프트 파일: `skills/build.md`) | 에러 로그 + Sentry 링크 |
...
| 상황 | 대응 |
|------|------|
| 배포 후 서비스 다운 | 즉시 롤백 → 에러 로그 수집 → **build** (프롬프트 파일: `skills/build.md`)에 버그 리포트 |
...
**이슈 기반 워크플로우:** 기능 개발은 **spec** (프롬프트 파일: `skills/spec.md`)이 PRD를 GitHub Issue로 분해하는 것에서 시작합니다.
**build** (프롬프트 파일: `skills/build.md`)는 이슈를 할당받아 작업하고, **ship** (프롬프트 파일: `skills/ship.md`)이 이슈 기반 브랜치에서 커밋/PR 생성/이슈 닫기를 수행합니다.
...
> **spec** (프롬프트 파일: `skills/spec.md`) (프롬프트 파일: `skills/spec.md`) → **ui** (프롬프트 파일: `skills/ui.md`) (프롬프트 파일: `skills/ui.md`) → **build** (프롬프트 파일: `skills/build.md`) (프롬프트 파일: `skills/build.md`) → **qa** (프롬프트 파일: `skills/qa.md`) (프롬프트 파일: `skills/qa.md`) → **ship** (프롬프트 파일: `skills/ship.md`) (프롬프트 파일: `skills/ship.md`) → **ops** (프롬프트 파일: `skills/ops.md`) (프롬프트 파일: `skills/ops.md`) → **docs** (프롬프트 파일: `skills/docs.md`) (프롬프트 파일: `skills/docs.md`)
