...
**입력:** **ship** (스킬: `.agent/skills/ship/`)의 릴리즈 태그 + 프로젝트 기술 스택
...
|----------|---------|---------------|
| 배포 기록 | **docs** (스킬: `.agent/skills/docs/`) | 배포 일시, 버전, 인프라 변경 |
| 문제 발생 | **build** (스킬: `.agent/skills/build/`) | 에러 로그 + Sentry 링크 |
...
| 상황 | 대응 |
|------|------|
| 배포 후 서비스 다운 | 즉시 롤백 → 에러 로그 수집 → **build** (스킬: `.agent/skills/build/`)에 버그 리포트 |
