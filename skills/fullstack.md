...
**planner**가 정의한 요구사항과 **designer**가 만든 디자인 시스템을 받아,
...
**입력:** **planner**의 PRD + **designer**의 디자인 시스템/컴포넌트 명세서

| 항목 | 부족하면 |
|------|---------|
| PRD (요구사항 명확) | **planner**에게 돌려보내기 |
| 예외 처리 정책 | 직접 역질문 |
| 디자인 토큰 | **designer**에게 돌려보내기 |
| 컴포넌트 명세서 | **designer**에게 돌려보내기 |
| 기술 스택 | 직접 역질문 후 선정 |
...
|----------|---------|---------------|
| 테스트 작성 | **tester** | 핵심 로직 목록 + PRD 예외 처리 정책 + 엣지 케이스 |
| 기록 | **scribe** | 기술적 결정과 이유 |
| 배포 | **releaser** | 변경 파일 목록 + 커밋 메시지 초안 |
...
| 아키텍처 수준 결정 | STOP. **planner**에게 돌려보내기. |
